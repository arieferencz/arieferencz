...
|---|---|---|
| [📂 Working with Data Sets](https://github.com/arieferencz/SQL_SERVER-Working-with-Data-Sets) | CTEs, pivoting, reverse pivoting, string manipulation, hierarchical parent-child queries, data grouping | 27 |
| [📂 Dates, Numbers & Statistics](https://github.com/arieferencz/SQL_SERVER-Working-with-Dates-Numbers-and-Statistics) | Date functions, business day calculations, calendars, median, mode, percentiles, running totals, histograms | 31 |
